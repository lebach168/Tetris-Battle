...
export const findLandingPosition = (curBoard: BoardGrid, block: Block, dRow: number, dCol: number): number => {
...
export const renderBlockOnBoard = (board: BoardGrid, dRow: number, dCol: number, block: Block) => {
